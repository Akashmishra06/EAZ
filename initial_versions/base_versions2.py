...
class algoLogic(optOverNightAlgoLogic):
    ...
    def run(self, startDate, endDate, baseSym, indexSym):
        ...
        df['callEntry'] = np.where((df['downBreakSpotFiftyMultiple'] == "downBreakSpotFiftyMultiple") & (df['ema10'] < df['ema10'].shift(1)), "callEntry", "")
        df['putEntry'] = np.where((df['upBreakSpotFiftyMultiple'] == "upBreakSpotFiftyMultiple") & (df['ema10'] > df['ema10'].shift(1)), "putEntry", "")
